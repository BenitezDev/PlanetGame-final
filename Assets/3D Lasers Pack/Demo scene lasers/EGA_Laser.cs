...
public class EGA_Laser : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //if (/*Laser != null &&*/ UpdateSaver == false)
        {
            ...
            //ShootLaser(Vector3 collision);
        //    RaycastHit hit;

        //    if (Physics.Raycast(transform.position, MachineGun.crosshair.transform.position, out hit, MaxLength))//CHANGE THIS IF YOU WANT TO USE LASERRS IN 2D: if (hit.collider != null)
        //    {
    ...
    public void ShootLaser(Vector3 collision)
    {
       
       
            // Laser.SetPosition(1, hit.point);

            HitEffect.transform.position = collision;
            HitEffect.transform.rotation = Quaternion.identity;
