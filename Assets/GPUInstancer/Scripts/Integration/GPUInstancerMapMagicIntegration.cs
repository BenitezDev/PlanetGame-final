    ...
    public class GPUInstancerMapMagicIntegration : MonoBehaviour
    {
        ...
        public void GeneratePrototypes()
        {
            ...
            if (importDetails)
            {
                ...
                GPUInstancerUtility.SetDetailInstancePrototypes(gameObject, detailPrototypes, terrainDetailPrototypes.ToArray(), 2, shaderBindings, billboardAtlasBindings, terrainSettings, true);
            }
            ...
            {
                GenerateMapMagicTerrainSettings();
                GPUInstancerUtility.SetTreeInstancePrototypes(gameObject, treePrototypes, terrainTreePrototypes.ToArray(), shaderBindings, billboardAtlasBindings, terrainSettings, true);
            }

            // import prefabs
            prefabPrototypes = new List<GPUInstancerPrototype>();
            if (importObjects)
                GPUInstancerUtility.SetPrefabInstancePrototypes(gameObject, prefabPrototypes, selectedPrefabs, shaderBindings, billboardAtlasBindings, true);
            else
        ...
        private void GenerateMapMagicTerrainSettings()
        {
            ...
            terrainSettings.terrainDataInstanceID = -1;
...
#endif
                shaderBindings = GPUInstancerManager.GetDefaultGPUInstancerShaderBindings();
            }
        }
#endif // MAPMAGIC
