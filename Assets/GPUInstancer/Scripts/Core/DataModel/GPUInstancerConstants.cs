...
namespace GPUInstancer
{
    ...
    public static class GPUInstancerConstants
    {
        ...
        public static readonly string[] VISIBILITY_COMPUTE_KERNELS = new string[] {
            ...
            "CSInstancedRenderingVisibilityKernelLOD0", "CSInstancedRenderingVisibilityKernelLOD1", "CSInstancedRenderingVisibilityKernelLOD2", "CSInstancedRenderingVisibilityKernelLOD3" };

        public static readonly string VISIBILITY_COMPUTE_RESOURCE_PATH = "Compute/CSInstancedRenderingVisibilityKernel";
#if !UNITY_EDITOR && (UNITY_IOS || UNITY_TVOS)
        public static readonly float VISIBILITY_SHADER_THREAD_COUNT = 512;
        ...
        public static readonly float VISIBILITY_SHADER_THREAD_COUNT = 128;
        ...
        public static class VisibilityKernelPoperties
        {
            ...
            public static readonly int BUFFER_PARAMETER_LOD_CF_SIZES = Shader.PropertyToID("lodCFSizes");
        ...
        public static readonly int PREFAB_EXTRA_BUFFER_SIZE = 16384;
