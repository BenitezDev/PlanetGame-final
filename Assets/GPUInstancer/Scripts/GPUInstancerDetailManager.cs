...
namespace GPUInstancer
{
    ...
    public class GPUInstancerDetailManager : GPUInstancerTerrainManager
    {
        ...
        public override void GeneratePrototypes(bool forceNew = false)
        {
            ...
            {
                GPUInstancerUtility.SetDetailInstancePrototypes(gameObject, prototypeList, terrain.terrainData.detailPrototypes, 2, shaderBindings, billboardAtlasBindings, terrainSettings, forceNew);
            }
        }
        ...
        public override void AddPickerObject(UnityEngine.Object pickerObject)
        {
            ...
            if (terrainSettings != null && terrain != null && terrain.terrainData != null)
            {
                List<DetailPrototype> newDetailPrototypes = new List<DetailPrototype>(terrain.terrainData.detailPrototypes);
                ...
                else if (pickerObject is GameObject)
                {
                    ...
                    terrain.terrainData.detailPrototypes = newDetailPrototypes.ToArray();
                    terrain.terrainData.RefreshPrototypes();
                    GPUInstancerUtility.AddDetailInstancePrototypeFromTerrainPrototype(gameObject, prototypeList, terrainDetailPrototype, newDetailPrototypes.Count - 1, 1, shaderBindings, billboardAtlasBindings, terrainSettings,
        ...
        public override void ApplyEditorDataChanges()
        {
            ...
            if (terrain.terrainData.detailPrototypes.Length != prototypeList.Count)
                return;
        ...
        public override void InitializeRuntimeDataAndBuffers(bool forceNew = true)
        {
            ...
            {
                GPUInstancerUtility.AddDetailInstanceRuntimeDataToList(runtimeDataList, prototypeList, shaderBindings, terrainSettings, detailLayer);
            }
